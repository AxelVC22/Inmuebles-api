...
describe('Pruebas de Autenticación', () => {
    ...
    describe('POST /api/auth/register', () => {
        ...
        it('Registra un arrendador correctamente (201)', async () => {
            ...
            const usuarioDb = await mockPrisma.usuario.findUnique({ where: { correoElectronico: nuevoArrendador.email } });
        ...
        it('Error por no RFC (400)', async () => {
            ...
            const usuarioDb = await mockPrisma.usuario.findUnique({ where: { correoElectronico: arrendadorSinRfc.email } });
    ...
    describe('POST /api/auth/login', () => {
        ...
        it('Correo no registrado (400)', async () => {
            ...
            expect(res.statusCode).toBe(400);
            expect(res.body.error).toMatch(/Correo electrónico o contraseña incorrectos|Credenciales inválidas/);
        });
    });
